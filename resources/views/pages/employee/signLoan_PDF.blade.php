...
<body class="bg-gray-100">
    <div class="container mx-auto p-4">
        <div class="flex gap-4">
            ...
            <div class="w-1/2 bg-white rounded-lg shadow-md p-4">
                ...
                <embed src="{{ route('documents.loans.preview', $loan->id) }}" type="application/pdf" width="100%"
                    height="600px" />
            </div>
    ...
    <script>
        ...
        function saveSignature() {
            ...
            // Send to server
            $.ajax({
                url: '{{ route('documents.sign.store', $loan->id) }}',
                method: 'POST',
                data: {
                ...
                success: function(response) {
                    window.location.href = '{{ route('documents.loans.index') }}';
                },
                error: function(xhr) {
                    console.error(xhr);
